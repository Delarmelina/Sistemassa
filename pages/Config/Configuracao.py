...
from pages.Config.tab_unidade import render_tab as Render_Unidades
from pages.Config.tab_categoria import render_tab as Render_Categorias
from pages.Config.tab_subcategoria import render_tab as Render_Subcategorias
